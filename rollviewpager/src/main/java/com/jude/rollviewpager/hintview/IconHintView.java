...
public class IconHintView extends ShapeHintView {
    private int focusResId;//有焦点的资源ID
    private int normalResId;//正常状态下的资源ID
    private int size;
    ...
    /**
     * 按照指定尺寸缩放图片:drawable-->bitmap:进行缩放; bitmap-->drawable返回
     * @param drawable
     * @param w
     * @param h
     * @return
    ...
    private Drawable zoomDrawable(Drawable drawable, int w, int h) {
        int width = drawable.getIntrinsicWidth();// 获取dip单位的尺寸
